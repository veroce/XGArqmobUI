...
open class AmDefaultButtonStyle: NSObject {
     ...
     */
    public var backgroundColorNormal: UIColor = UIColor(named: "buttonEnableColor") ?? UIColor(named: "buttonEnableColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .clear
    /**
     The backgroun color for highlighted state. Default is `buttonHighlightedColor` .
     */
    public var backgroundColorHighlighted: UIColor = UIColor(named: "buttonHighlightedColor") ?? UIColor(named: "buttonHighlightedColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .clear
    /**
     The backgroun color for disabled state. Default is `buttonDisabledColor` .
     */
    public var backgroundColorDisabled: UIColor = UIColor(named: "buttonDisabledColor") ?? UIColor(named: "buttonDisabledColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .clear
