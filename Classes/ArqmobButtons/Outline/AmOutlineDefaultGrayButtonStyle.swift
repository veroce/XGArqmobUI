...
open class AmOutlineDefaultGrayButtonStyle: NSObject {
     ...
     */
    public var borderColorNormal: UIColor = UIColor(named: "buttonGrayEnableColor") ?? UIColor(named: "buttonGrayEnableColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .darkGray
    /**
     The backgroun color for highlighted state. Default is `buttonHighlightedColor` .
     */
    public var borderColorHighlighted: UIColor = UIColor(named: "buttonGrayHighlightedColor") ?? UIColor(named: "buttonGrayHighlightedColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .darkGray
    /**
     The backgroun color for disabled state. Default is `buttonDisabledColor` .
     */
    public var borderColorDisabled: UIColor = UIColor(named: "buttonGrayDisabledColor") ?? UIColor(named: "buttonGrayDisabledColor", in: Bundle(for: AmDefaultButton.self), compatibleWith: nil) ?? .darkGray
