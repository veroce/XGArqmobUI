...
public class AmAboutUsStyle: NSObject {
     ...
     */
    public var title: UIColor = UIColor(named: "secondaryTextColor", in: Bundle(for: AmAboutUsStyle.self), compatibleWith: nil) ?? UIColor.darkGray
    /**
     The version info color. Default is `systemColor` .
     */
    public var infoColor: UIColor = UIColor(named: "primaryTextColor", in: Bundle(for: AmAboutUsStyle.self), compatibleWith: nil) ?? UIColor.darkGray
