...
extension UIToolbar {
 ...
 open class AnimatedField: UIView {
    ...
    @IBOutlet weak private var leftIcon: UIImageView!
    ...
    open var format = AnimatedFieldFormat() {
        didSet {
            ...
            if !format.visibleLeftImage {
                leftIcon.removeFromSuperview()
            }else{
                leftIcon.image = format.leftImage
                leftIcon.tintColor = format.leftIconColor
            }
        }
    }
...
extension AnimatedField {
    ...
    func animateOutAlert(_ fromError: Bool = false) {
        alertLabel.text = ""
         isPlaceholderVisible = true
        if fromError {
...
extension AnimatedField: AnimatedFieldInterface {
    ...
    open func restart() {
        ...
        textField.text = ""
        if format.visibleLeftImage {
            leftIcon.tintColor = format.textColor
        }
    }
    ...
    open func showAlert(_ message: String? = nil) {
        ...
        titleLabel.textColor = format.alertColor
        if format.visibleLeftImage {
            leftIcon.tintColor = format.alertColor
        }
