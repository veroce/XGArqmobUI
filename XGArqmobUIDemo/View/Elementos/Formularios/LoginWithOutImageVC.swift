...
import UIKit
import XGArqmobUI
class LoginWithOutImageVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lbBienvenido.textColor = UIColor(named: "primaryColor")
...
extension LoginWithOutImageVC: AnimatedFieldDataSource {
